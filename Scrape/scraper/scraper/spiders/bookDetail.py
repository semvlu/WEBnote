    ...
    def parse(self, response):
        ...
        for book in books:
            ...
            if 'catalogue/' in relativeUrl:
                bkUrl =  'https://books.toscrape.com/' + relativeUrl
            else: bkUrl = 'https://books.toscrape.com/catalogue/' + relativeUrl
            yield response.follow(relativeUrl, callback=self.parse_bkPg, 
